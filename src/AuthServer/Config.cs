    ...
    public class Config
    {
        ...
        public static IEnumerable<Client> GetClients(string devHost = "")
        {
            return new[]
            {
                ...
                //    RedirectUris = {$"https://localhost:8787/test-client/callback.html"}, // test client runs on same host
                //    AllowedCorsOrigins = {$"https://localhost:8787" }, // test client runs on same host
                ...
                new Client {
                    ...
                    AllowedCorsOrigins = {$"https://localhost:5001" }, // test client runs on same host
                    AccessTokenLifetime = (int)TimeSpan.FromMinutes(120).TotalSeconds
                },
                 new Client {
                    RequireConsent = false,
